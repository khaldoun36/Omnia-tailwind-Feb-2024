...
}, "/Users/khaldounalnuaimi/Desktop/Omnia_new/omnia_landing-page/node_modules/astro/components/Image.astro", void 0);
...
const aboutMeImage = new Proxy({"src":"/_astro/about-me-page.iXdNLbsj.jpg","width":873,"height":833,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/khaldounalnuaimi/Desktop/Omnia_new/omnia_landing-page/src/assets/images/about-me-page.jpg";
							}
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "about" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="grid gap-16 lg:grid-cols-5"> <main class="order-2 lg:order-1 lg:col-span-3"> <h1 class="text-4xl font-bold text-neutral-800 md:text-5xl">
I&#x27;m Sam Foulkes - Online & PT Transformation Coach
</h1> <div class="about-me-text mt-8 flex flex-col items-start gap-6"> ${aboutMe.map((text) => renderTemplate`<p class="text-base text-neutral-600">${text}</p>`)} </div> </main> <aside class="order-1 lg:order-2 lg:col-span-2"> ${renderComponent($$result2, "Image", $$Image, { "src": aboutMeImage, "class": "aspect-square h-auto max-w-full rotate-2 rounded-md object-cover md:size-64 lg:aspect-square lg:size-max", "format": "webp", "alt": "Image of a person walking in a forest somewhere in Japan." })} <div class="mt-6 hidden flex-col justify-start gap-6 lg:flex"> <a class="flex items-center justify-start gap-3 text-sm font-medium text-neutral-500 transition-colors hover:text-neutral-700 focus:text-neutral-700 focus:outline-none" href="https://www.instagram.com/omnia.samfoulkes/?hl=en" target="_blank"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "ph:instagram-logo", "class": "text-xl" })} <span>Instagram</span> </a> <a class="flex items-center justify-start gap-3 text-sm font-medium text-neutral-500 transition-colors hover:text-neutral-700 focus:text-neutral-700 focus:outline-none" href="mailto:omnia.samfoulkes@gmail.com" target="_blank"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "ph:envelope-simple", "class": "text-xl" })} <span>omnia.samfoulkes[at]gmail.com</span> </a> </div> </aside> <div class="order-3 flex flex-col justify-start gap-6 lg:hidden"> <a class="flex items-center justify-start gap-3 text-sm font-medium text-neutral-500 transition-colors hover:text-neutral-700 focus:text-neutral-700 focus:outline-none" href="https://www.instagram.com/omnia.samfoulkes/?hl=en" target="_blank"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "ph:instagram-logo", "class": "text-xl" })} <span>Instagram</span> </a> <a class="flex items-center justify-start gap-3 text-sm font-medium text-neutral-500 transition-colors hover:text-neutral-700 focus:text-neutral-700 focus:outline-none" href="mailto:omnia.samfoulkes@gmail.com" target="_blank"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "ph:envelope-simple", "class": "text-xl" })} <span>omnia.samfoulkes[at]gmail.com</span> </a> </div> </div> ` })}`;
}, "/Users/khaldounalnuaimi/Desktop/Omnia_new/omnia_landing-page/src/pages/about.astro", void 0);

const $$file = "/Users/khaldounalnuaimi/Desktop/Omnia_new/omnia_landing-page/src/pages/about.astro";
const $$url = "/about";
...
export { $$Image as $, about as a, getConfiguredImageService as g, imageConfig as i };
